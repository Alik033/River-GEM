...
parser.add_argument('--data_path', default='../River-UIEB_v1/train/')
...
parser.add_argument('--end_epoch', type=int, default=51)
...
parser.add_argument('--testing_dir_inp', default="../River-UIEB_v1/test/raw/")
parser.add_argument('--testing_dir_gt', default="../River-UIEB_v1/test/GT/")
parser.add_argument('--testing_dir_depth', default="../River-UIEB_v1/test/depths/")
